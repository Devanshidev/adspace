      ...
      {Number(step) == 1 && (
        <div className="flex flex-col  gap-3  items-center">
          <div className="flex flex-col gap-6">
            <FeatureCard
              img={<Image src={IMG1} alt="image-1"className = 'h-[60px] w-[60px]'/>}
              heading="Individual"
              para="Advertise your own app or service to gain traction within the Grovyo user base.."
              flag="true"
            />
            <FeatureCard
              img={<Image src={IMG2} alt="image-1" className = 'h-[60px] w-[60px]'/>}
              heading="Organization"
              para="Promote your company's apps and services to a wider audience."
              flag="false"
            />
            <FeatureCard
              img={<Image src={IMG3} alt="image-1" className = 'h-[60px] w-[60px]'/>}
              heading="Affiliator"
