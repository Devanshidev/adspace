    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex justify-between w-[861px]">
        <div className="flex flex-col items-center gap-2">
          <div className="h-[20px] w-[20px] rounded-full bg-[#114763] text-white text-center align-middle leading-[20px]">1</div>
          <div className="text-[#114763]">Select Your Type</div>
        </div>
        <div className="flex flex-col items-center gap-2">
        <div className="h-[20px] w-[20px] rounded-full bg-black text-white text-center align-middle leading-[20px]">2</div>
          <div >Provide your Basic Info</div>
        </div>
        <div className="flex flex-col items-center gap-2">
        <div className="h-[20px] w-[20px] rounded-full bg-[#0D0D0DB2] text-white text-center align-middle leading-[20px]">3</div>
      ...
      <div className="space-y-4 mt-[50px]">
        <div className="flex border rounded-lg gap-8 hover:border-blue-400 p-4 cursor-pointer items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-[12px]">Advertise your own app or service to gain traction within the Grovyo user base.</div>
          </div>
        </div>
        <div className="flex border rounded-lg gap-8 hover:border-blue-400 p-4 cursor-pointer items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-[12px]">Promote your company's apps and services to a wider audience.</div>
          </div>
        </div>
        <div className="flex border rounded-lg gap-8 hover:border-blue-400 p-4 cursor-pointer items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-[12px]">Run ads for multiple accounts and earn cashback on your ad spend</div>
          </div>
        </div>
      </div>
      <div className="border rounded-lg bg-blue-500 mt-8 text-white text-[12px] py-2 px-4 cursor-pointer">Continue &#10230;</div>
    </div>
  );
};
