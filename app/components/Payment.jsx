...
const Payment = () => {
  const {form1, form2} = useSelector((state) => state.createad);
  return (
      ...
      <div className="flex flex-col gap-5 border-2 border-[#D7D7D7] rounded-lg p-3">
        ...
        <section className="flex gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[11px] font-semibold">{form1.objective.name}</p>
          </div>
        </section>
        <hr />
          ...
          <div className="flex flex-col justify-between gap-2">
            ...
            <div className="flex gap-4">
              <h1 className="flex flex-col gap-2">
                ...
                <span className="text-[12px] font-semibold">{form2.totalBudget}</span>
              </h1>
              <h1 className="flex flex-col gap-2">
                <span className="text-[12px] font-semibold">Daily Budget</span>
                <span className="text-[12px] font-semibold">{form2.dailyBudget}</span>
              </h1>
            </div>
          </div>
          <div className="flex flex-col justify-between gap-2">
            ...
            <div className="flex gap-4">
              <h1 className="flex flex-col gap-2">
                ...
                <span className="text-[12px] font-semibold">{form2.startDate}</span>
              </h1>
              <h1 className="flex flex-col gap-2">
                <span className="text-[12px] font-semibold">End Date</span>
                <span className="text-[12px] font-semibold">{form2.endDate}</span>
              </h1>
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <div className="flex gap-10">
            <p className="flex flex-col gap-2">
              ...
              <span className="text-[12px] font-semibold">{form2.gender}</span>
            </p>
            <p className="flex flex-col gap-2">
              <span className="text-[12px] text-[#686B6E] ">Age Group</span>
              <span className="text-[12px] font-semibold">{form2.ageGroup}</span>
            </p>
            <p className="flex flex-col gap-2">
