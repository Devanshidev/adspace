  ...
  return (
    <>
      <div className="md:w-full flex ss:w-full">
        ...
        <button className="ml-3 text-xs font-Jost font-normal border border-gray-200 rounded-xl bg-slate-50 pl-1.5 pr-1.5 py-0.5 text-[#747677]">
        Status: Active
         </button>
        </div>
      </div>
      ...
      <div className="overflow-x-scroll">
        <table className="w-full border-gray-300  sm:w-full ">
          <thead>
            <tr>
