    ...
    return (
        <>
            <div className="pl-5 ss:w-full ss:flex-col ss:mb-5 pp:mb-8 sm:flex sm:flex-row sm:justify-between sm:mb-10 md:w-3/4">
                <div className="font-Jost sm:text-2xl font-semibold ss:text-xl ss:mb-3 "> Overview</div>
                <div className="pp:flex sm:items-center sm:gap-4 pp:gap-20"><div><button className=" font-Jost border-solid border border-gray-300
 text-xs p-2 bg-white font-light rounded-l-lg focus:bg-neutral-200 ">Last 30 days</button>
                    <button className=" font-Jost border-solid border border-gray-300
      text-xs p-2 bg-white font-light focus:bg-neutral-200">Last 7 days</button>
                    <button className="font-Jost border-solid border border-gray-300
 text-xs p-2 bg-white font-light rounded-r-lg focus:bg-neutral-200">Last 24 hours</button></div>
                    <div><button className="font-Jost border-solid border border-gray-300
 text-xs p-2 bg-white font-light rounded-md flex gap-1.5 focus:bg-neutral-200"><svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.875 6.375H4.125V7.625H2.875V6.375ZM11.625 3.25V12C11.625 12.6875 11.0625 13.25 10.375 13.25H1.625C0.93125 13.25 0.375 12.6875 0.375 12L0.38125 3.25C0.38125 2.5625 0.93125 2 1.625 2H2.25V0.75H3.5V2H8.5V0.75H9.75V2H10.375C11.0625 2 11.625 2.5625 11.625 3.25ZM1.625 4.5H10.375V3.25H1.625V4.5ZM10.375 12V5.75H1.625V12H10.375ZM7.875 7.625H9.125V6.375H7.875V7.625ZM5.375 7.625H6.625V6.375H5.375V7.625Z" fill="#747677" />
                        </svg>
                        Custom</button></div>
                </div></div>
            <div className="sm:flex sm:gap-4 sm:mx-3 md:ml-3 ss:w-auto ss:grid grid-cols-2 ss:gap-2 md:w-3/4">
                <div className="bg-white border-solid border-1 border-gray-300 md:w-56 p-2 rounded-md ss:w-40 pp:w-48">
                    <div className="flex items-center justify-between font-Jost md:text-sm text-slate-400 mb-1.5 ss:text-xs">
                        Amount Spent <div className="w-4 h-4 rounded-full bg-red-600">  </div>
                    </div>
                    <div className="font-Jost font-semibold ss:text-xs md:text-base">₹0.00</div>
                </div>
                <div className="bg-white border-solid border-1 border-gray-300 md:w-56 p-2 rounded-md ss:w-40 pp:w-48">
                    <div className="flex items-center justify-between font-Jost md:text-sm text-slate-400 mb-1.5 ss:text-xs">
                        Impressions <div className="w-4 h-4 rounded-full bg-blue-400">  </div>
                    </div>
                    <div className="font-Jost font-semibold ss:text-xs md:text-base">0</div>
                </div>
                <div className="bg-white border-solid border-1 border-gray-300 md:w-56 p-2 rounded-md ss:w-40 pp:w-48">
                    <div className="flex items-center justify-between font-Jost md:text-sm text-slate-400 mb-1.5 ss:text-xs">
                        Clicks <div className="w-4 h-4 rounded-full bg-orange-400">  </div>
                    </div>      <div className="font-Jost font-semibold ss:text-xs md:text-base">0</div>
                </div>
                <div className="bg-white border-solid border-1 border-gray-300 md:w-56 p-2 rounded-md ss:w-40 pp:w-48">
                    <div className="flex items-center justify-between font-Jost md:text-sm text-slate-400 mb-1.5 ss:text-xs">
            ...
            <div className=" bg-white md:w-3/4 mt-8 rounded-md sm:p-5 ss:w-auto ss:p-2"><div className="font-Jost flex justify-between mb-10 items-center ss:text-sm ss:mb-5 sm:text-base">Campaign (3)
                <button className="font-Jost border-solid border-2 border-gray-300
 text-xs p-2 bg-white font-light rounded-md flex gap-1.5 focus:bg-neutral-200">
                    <div className="flex sm:gap-10 px-1 ss:gap-4 ">All Campaign <div className="mt-1"><svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
